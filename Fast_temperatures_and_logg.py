...
name=191116000701315
filename = 'quick/'+cluster_name+'_reduction/'+str(name)
...
with Pool(processes=10) as pool:
    ...
    sampler = emcee.EnsembleSampler(nwalkers, ndim, log_posterior,backend=backend,pool=pool,args=[params_short,prior,True,parameters])
