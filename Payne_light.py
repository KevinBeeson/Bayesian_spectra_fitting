...
uncs_all=[]
observed_spectra=[]
to_be_reduced=all_reduced_data[::100]
spectras=spectrum_all(170711001501172,cluster=False)
...
#     np.save('testing_fit_6',large_results)
...
#     # a=pm.find_MAP()
#     idata_mh = pm.sample(100, tune=100,return_inferencedata=True)
